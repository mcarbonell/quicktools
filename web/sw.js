...
const CACHE_NAME = 'fasttools-v2.1.4';
const STATIC_CACHE = 'fasttools-static-v2.1.4';
const DYNAMIC_CACHE = 'fasttools-dynamic-v2.1.4';
...
self.addEventListener('install', (event) => {
    console.log('[SW] Installing Service Worker v2.1.4');
...
self.addEventListener('activate', (event) => {
    console.log('[SW] Activating Service Worker v2.1.4');
