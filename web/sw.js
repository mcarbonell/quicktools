...
const CACHE_NAME = 'fasttools-v3.0.47';
const STATIC_CACHE = 'fasttools-static-v3.0.47';
const DYNAMIC_CACHE = 'fasttools-dynamic-v3.0.47';
...
self.addEventListener('install', (event) => {
    console.log('[SW] Installing Service Worker v3.0.47');
...
self.addEventListener('activate', (event) => {
    console.log('[SW] Activating Service Worker v3.0.47');
