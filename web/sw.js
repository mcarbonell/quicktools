...
const CACHE_NAME = 'fasttools-v2.1.3';
const STATIC_CACHE = 'fasttools-static-v2.1.3';
const DYNAMIC_CACHE = 'fasttools-dynamic-v2.1.3';
...
self.addEventListener('install', (event) => {
    console.log('[SW] Installing Service Worker v2.1.3');
...
self.addEventListener('activate', (event) => {
    console.log('[SW] Activating Service Worker v2.1.3');
